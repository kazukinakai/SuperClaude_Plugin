...
# /sc:sc:sc:index - Project Documentation
...
## Usage
```
/sc:sc:index [target] [--type docs|api|structure|readme] [--format md|json|yaml]
```
...
```
/sc:sc:index project-root --type structure --format md
...
```
/sc:sc:index src/api --type api --format json
