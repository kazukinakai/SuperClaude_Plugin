...
# /sc:sc:sc:save - Session Context Persistence
...
## Usage
```
/sc:sc:save [--type session|learnings|context|all] [--summarize] [--checkpoint]
```
...
```
/sc:sc:save --type all --checkpoint
