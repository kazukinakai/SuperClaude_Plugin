...
# /sc:sc:sc:build - Project Building and Packaging
...
## Usage
```
/sc:sc:build [target] [--type dev|prod|test] [--clean] [--optimize] [--verbose]
```
...
```
/sc:sc:build --type prod --clean --optimize
