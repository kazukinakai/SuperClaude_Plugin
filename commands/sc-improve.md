...
```
/sc:sc:improve src/ --type quality --safe
...
```
/sc:sc:improve api-endpoints --type performance --interactive
...
```
/sc:sc:improve legacy-modules --type maintainability --preview
...
### Security Hardening
```
/sc:sc:improve auth-service --type security --validate
